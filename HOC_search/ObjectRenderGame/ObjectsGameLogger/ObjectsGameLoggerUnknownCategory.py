...
class ObjectsGameLoggerUnknownCategory(MCTSLogger):
    """
    Objects Game Logger
    ...
    def log_mcts(self, iter, last_score, last_tree_depth, mc_tree):
        ...
        category_label = self.game.prop_seq[0].category_label
        base_rotation = self.game.prop_seq[1].rotation_degree
        ...
        self.game.all_mcts_results_dict['category_list'].append(category_label)
        ...
        if iter % self.log_config.export_graph_every == self.log_config.export_graph_every - 1:
            ...
            self.drawGraph(mc_tree, tree_file_path, K=2,D=-1)
